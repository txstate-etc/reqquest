    ...
    execute: async (db: Queryable) => {
      await db.execute(`
        CREATE TABLE IF NOT EXISTS requirement_prompts (
          ...
          reachable TINYINT UNSIGNED NOT NULL DEFAULT 0,
          askedInEarlierRequirement TINYINT UNSIGNED NOT NULL DEFAULT 0,
          askedInEarlierApplication TINYINT UNSIGNED NOT NULL DEFAULT 0,
