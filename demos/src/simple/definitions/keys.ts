 ...
 */
export type SimplePromptKey = KeysOfModule<typeof import('./prompts/index.js')>
export type SimpleRequirementKey = KeysOfModule<typeof import('./requirements/index.js')>
