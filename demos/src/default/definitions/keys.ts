 ...
 */
export type DefaultPromptKey = KeysOfModule<typeof import('./prompts/index.js')>
export type DefaultRequirementKey = KeysOfModule<typeof import('./requirements/index.js')>
