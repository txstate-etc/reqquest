...
export const load: LayoutLoad = async ({ params, depends }) => {
  ...
  if (![enumAppRequestStatus.STARTED, enumAppRequestStatus.READY_TO_SUBMIT].includes(appRequest.status as any)) throw error(404, 'This application has already been submitted.')
