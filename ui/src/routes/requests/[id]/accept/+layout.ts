...
export const load: LayoutLoad = async ({ params, depends }) => {
  ...
  if (![enumAppRequestStatus.ACCEPTANCE, enumAppRequestStatus.READY_TO_ACCEPT].includes(appRequest.status as any)) throw error(404, 'This application cannot be accepted at this time.')
