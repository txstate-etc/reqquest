...
{#key prompt.id}
  ...
  <Form bind:store hideFallbackMessage submit={onSubmit} validate={onValidate} preloadAsDraft={!prompt.hasSavedData} preload={prompt.preloadData}  on:saved={onSaved} let:data>
