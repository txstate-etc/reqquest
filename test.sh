...
docker-compose -p "$(basename $PWD)-test" -f docker-compose.test.yml $override up --build --abort-on-container-exit --exit-code-from testing-container --attach testing-container
EXITCODE=$?
